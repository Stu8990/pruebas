...
| Styling | `styles.css`, tokens on `:root`. Three permanent design options, chosen in Más → Diseño (`html[data-palette]`: jacaranda default, ambar, guayaba; each sets colors, fonts, radii and its auth background `assets/hero-<id>.webp`, generated by Codex). Light by default; Tema: Claro/Oscuro/Automático |
